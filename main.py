...
while True:
    ...
    if results[0]:
        if results[0].boxes[0].conf[0] > 0.5:  # Если значение совпадения больше 60%...
            ...
            xcm = (xc - xcf) * dist # Вычисление координаты центра автомобиля-нарушителя относительно центра кадра в сантиметрах по оси X
            ycm = (yc - ycf) * dist # Вычисление координаты центра автомобиля-нарушителя относительно центра кадра в сантиметрах по оси Y
